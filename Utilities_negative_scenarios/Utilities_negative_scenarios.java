...
public class Utilities_negative_scenarios  extends Generic_functions{
	...
	public void user_should_get_validation_message_on_entering_invalid_details_in_add_bank_page() throws IOException {
		try {
		page_wait(10);
	...
	public void user_is_not_able_to_click_on_redeem() throws IOException {
	 try {
	   click("back_btn");
	   click("manage_back");
	   click("award_points");

...
Scenario: Validate that the mpowered health logo/hamburger  should be present in the header
Given App is open
...
Scenario: Validate that the user is navigated to the help or FAQ page on clicking Help or FAQ icon
